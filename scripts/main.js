...
var countDownDate = new Date('Dec 26 2022 13:47:50 GMT+0800').getTime();
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    ...
    let redbags = new Array(20).fill(0).forEach(x => {
      document.body.innerHTML += `<img src="images/cake.png" class="img" style="animation-duration: ${Math.random()*2+3}s;left: ${Math.random()*(clientWidth-40)+20}px;" />`
